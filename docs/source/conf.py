...
# -*- coding: utf-8 -*-
#
# ipyreact documentation build configuration file
#
...
project = "ipyreact"
copyright = "2023, Maarten A. Breddels"
...
_version_py = os.path.join(repo, "ipyreact", "_version.py")
version_ns = {}
...
latex_documents = [
    (master_doc, "ipyreact.tex", "ipyreact Documentation", "Maarten A. Breddels", "manual"),
]
...
man_pages = [(master_doc, "ipyreact", "ipyreact Documentation", [author], 1)]
