...
# your default requirements, the wheel version number (0.6.0) is bumped up for each new release using bump2version
requirements = f"""solara
https://py.cafe/gh/artifact/{repo_name}/actions/runs/{run_id}/{artifact_name}/ipyreact-0.6.0-py3-none-any.whl
"""
